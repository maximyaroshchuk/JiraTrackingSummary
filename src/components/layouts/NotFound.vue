...
<template>
    <div
        ...
        <div class="w-6 sm:w-12 z-1 flex flex-column align-items-center">
            <h1 class="text-900 font-bold text-center text-5xl mb-2">{{ pageTitle }}</h1>
            <span class="text-900 text-center lg:text-xl font-medium mb-0 block m-3">{{ pageMessage }}</span>
