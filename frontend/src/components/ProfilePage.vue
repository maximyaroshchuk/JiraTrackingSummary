    ...
    <TSCard class="card h-auto">
        ...
        <TSForm v-else layout="vertical">
            ...
            <TSFormItem label="Jira API Key" class="text-left">
                ...
                <small class="text-color-secondary">Jira API Key This is a personal authentication token required to access Jira's API. You can generate it in your <a href='https://rvlnk.link/jtsaapikeys' target='_blank'>Atlassian API Token Management</a> settings. Once created, copy and store it securely, as it will not be shown again.</small>
            </TSFormItem>
